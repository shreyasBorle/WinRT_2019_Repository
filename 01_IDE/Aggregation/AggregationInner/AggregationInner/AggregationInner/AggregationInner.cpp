...
//interface decleration only i.e is not for decleration in .h file it only for internal uses.
...
public:
	...
	//aggretaion supported method decleartion
	HRESULT __stdcall QueryInterface(REFIID, void **);
	ULONG __stdcall AddRef(void);
	ULONG __stdcall Release(void);

	//aggregation nonsuported method decleration.
	...
	//mutliplication specific delceration
	HRESULT __stdcall MultiplicationOfTwoIntegers(int, int, int *);
	//divisionspecific decleration
...
public:
	...
	//IClassfactory specific method decleration
...
//implementation of Cmultiplicationdiviosn contructor method;
...
//noaggregation method implemntaion;
