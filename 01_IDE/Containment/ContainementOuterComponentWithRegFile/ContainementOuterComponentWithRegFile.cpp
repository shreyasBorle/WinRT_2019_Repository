#include<windows.h>
#include"ContainementOuterComponentWithRegFile.h"
...
//implementaion of sum and subtract 
...
//inner server method implementation.
...
HRESULT CSumSubtractClassFactory::CreateInstance(IUnknown *pUnkOuter, REFIID riid, void **ppv)
{
	...
	if (FAILED(hr))
	{
		MessageBox(NULL, TEXT("Failed to initialize Inner Componet"), TEXT("ERROR"), MB_OK);
